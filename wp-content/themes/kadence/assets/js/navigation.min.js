  ...
  (window.kadence = {
        ...
        for (let a = 0; a < t.length; a++) {
          ...
          if (o.querySelector(".dropdown-nav-toggle")) {
            ...
            i.setAttribute(
              "aria-label",
              n
                ? kadenceConfig.screenReader.expandOf + " " + n
                : kadenceConfig.screenReader.expand
            ),
              i.classList.add("dropdown-nav-special-toggle"),
              o.insertBefore(i, o.childNodes[1]),
              ...
              o.querySelector("a").addEventListener("focus", function (e) {
                ...
                for (let n = 0; n < t.length; n++)
                  o !== t[n] && window.kadence.toggleSubMenu(t[n], !1);
              }),
                ...
                9 === e.keyCode &&
                  (e.shiftKey
                    ? window.kadence.isfirstFocusableElement(
                        ...
                        o
                      ) && window.kadence.toggleSubMenu(t[a].parentNode, !1)
      ...
      if (
        ...
        e.classList.remove("menu-item--toggled-on"),
          ...
          o.setAttribute(
            "aria-label",
            a
              ? kadenceConfig.screenReader.expandOf + " " + a
              : kadenceConfig.screenReader.expand
          );
        ...
        for (let e = 0; e < d.length; e++)
          window.kadence.toggleSubMenu(d[e], !1);
        e.classList.add("menu-item--toggled-on"),
          n.classList.add("toggle-show"),
          o.setAttribute(
            "aria-label",
            a
              ? kadenceConfig.screenReader.collapseOf + " " + a
      ...
      if (n) {
        ...
        if (
          ...
          o.dataset.toggleBodyClass &&
            document.body.classList.remove(o.dataset.toggleBodyClass),
          ...
          o.dataset.toggleBodyClass &&
            (document.body.classList.toggle(o.dataset.toggleBodyClass),
            o.dataset.toggleBodyClass.includes("showing-popup-drawer-") &&
              (document.body.style.setProperty("--scrollbar-offset", i + "px"),
        ...
        document.addEventListener("keyup", function (e) {
          ...
          document.addEventListener("click", function (e) {
            ...
            t ===
              ...
              window.kadence.toggleDrawer(
                document.querySelector(
                  '*[data-toggle-target="' + n.dataset.drawerTargetString + '"]'
                )
              );
    ...
    initStickyHeader: function () {
      ...
      parseInt(kadenceConfig.breakPoints.desktop) < window.innerWidth
        ? ((a = "desktop"),
          e &&
            ...
            (d = window.kadence.getOffset(e).top),
            (e.style.position = null)))
        : t &&
          ((t.style.position = "static"),
          (d = window.kadence.getOffset(t).top),
      ...
      var s,
        ...
        u = function (s) {
          ...
          if (
            (l = kadenceConfig.breakPoints.desktop <= window.innerWidth ? e : t)
          ) {
            kadenceConfig.breakPoints.desktop <= window.innerWidth
              ? "mobile" === a
                ? ((d = window.kadence.getOffset(l).top), (a = "desktop"))
                : s &&
                  "updateActive" === s &&
                  ((l.style.top = "auto"),
                  (d = window.kadence.getOffset(l).top),
                  (a = "desktop"))
              : "desktop" === a
              ? ((d = window.kadence.getOffset(l).top), (a = "mobile"))
              : s &&
                "updateActive" === s &&
                ((l.style.top = "auto"),
                (d = window.kadence.getOffset(l).top),
            ...
            if (
              ((!p ||
                ...
                (p = l.offsetHeight),
                w.classList.contains("site-header-upper-inner-wrap")
                  ? ((w.style.height = null),
                    s && void 0 !== s.type && "orientationchange" === s.type
                      ? l.classList.contains("item-is-fixed")
                        ? setTimeout(function () {
                            w.style.height =
                              Math.floor(w.offsetHeight + l.offsetHeight) +
                              "px";
                          }, 21)
                        : setTimeout(function () {
                      ...
                      : (w.style.height = w.offsetHeight + "px"))
                  : w.classList.contains("site-header-inner-wrap")
                  ? ((w.style.height = null),
                    (w.style.height = w.offsetHeight + "px"))
                  : (w.style.height = l.offsetHeight + "px")),
              "true" === h)
            ) {
              ...
              if (v) {
                if ("true" === m)
                  if (window.scrollY > r)
                    var y = Math.floor(
                      Math.floor(d) - Math.floor(c) + Math.floor(p)
                    );
                ...
                if (
                  (L ||
                    (k.setAttribute("data-start-height", k.offsetHeight),
                    (L = k.offsetHeight)),
                  window.scrollY <= y)
                ) {
                  if (
                    ((k.style.height = L + "px"),
                    (k.style.minHeight = L + "px"),
                    (k.style.maxHeight = L + "px"),
                    b)
                  )
                  ...
                  if (
                    ((k.style.height = S + "px"),
                    (k.style.minHeight = S + "px"),
                    (k.style.maxHeight = S + "px"),
                    b)
                  )
                    for (let e = 0; e < b.length; e++) {
            ...
            if ("true" === m) {
              ...
              if (E <= x) l.style.transform = "translateY(0px)";
                ...
                l.classList.add("item-hidden-above"),
                  (l.style.transform =
                    "translateY(" + (Math.abs(M) > A ? -A : M) + "px)");
              else {
                x = Math.floor(d - c);
                (l.style.transform = "translateY(" + (M > 0 ? 0 : M) + "px)"),
                  l.classList.remove("item-hidden-above");
              }
              r = E;
            } else x = Math.floor(d - c);
            window.scrollY == x
              ? ((l.style.top = c + "px"),
                l.classList.add("item-is-fixed"),
                l.classList.add("item-at-start"),
                l.classList.remove("item-is-stuck"),
                w.classList.add("child-is-fixed"),
                document.body.classList.add("header-is-fixed"))
              : window.scrollY > x
              ? "true" === m
                ? window.scrollY < A + 60 &&
                  l.classList.contains("item-at-start")
                  ? ((l.style.height = null),
                    (l.style.top = c + "px"),
                    l.classList.add("item-is-fixed"),
                    l.classList.add("item-is-stuck"),
                    w.classList.add("child-is-fixed"),
                    document.body.classList.add("header-is-fixed"))
                  : ((l.style.top = c + "px"),
                    l.classList.add("item-is-fixed"),
                    l.classList.add("item-is-stuck"),
                    l.classList.remove("item-at-start"),
                    w.classList.add("child-is-fixed"),
                    document.body.classList.add("header-is-fixed"))
                : ((l.style.top = c + "px"),
                  l.classList.add("item-is-fixed"),
                  ...
                  document.body.classList.add("header-is-fixed"))
              : l.classList.contains("item-is-fixed") &&
                (l.classList.remove("item-is-fixed"),
                l.classList.remove("item-at-start"),
                l.classList.remove("item-is-stuck"),
                (l.style.height = null),
                (l.style.top = null),
                w.classList.remove("child-is-fixed"),
    ...
    anchorScrollToCheck: function (e, t) {
      ...
      if (
        ...
        i &&
          (i?.classList?.contains("kt-accordion-pane") ||
            (e.preventDefault(), window.kadence.scrollToElement(i)));
      }
    },
